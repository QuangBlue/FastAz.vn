...
class FastAZ(MDApp):
    ...
    def button_change_color(self, x):
        ...
        for k in l:
            if x == k:
                r = exec(
                    f"self.strng.get_screen('dashboardscreen').ids.{x}.md_bg_color = (255/255, 255/255, 255/255, 1)")
                ...
                for i in l:
                    if i == x:
                        ...
                        exec(
                            f"self.strng.get_screen('dashboardscreen').ids.{i}.text_color = (255/255, 255/255, 255/255, 1)")
                        exec(
                            f"self.strng.get_screen('dashboardscreen').ids.{i}.icon_color = (255/255, 255/255, 255/255, 1)")
                        exec(
                            f"self.strng.get_screen('dashboardscreen').ids.{i}.md_bg_color = (40/255, 40/255, 40/255, 1)")
                break
